            ...
            {releases.map((release, i) => (
              ...
              >
                <div className="h-24 w-24 sm:h-32 sm:w-32 relative flex-shrink-0 rounded-sm overflow-hidden border border-[var(--border)]">
                   <SafeImage src={release.coverArtUrl} storageId={release.coverArtStorageId} alt="" className="h-full w-full object-cover shadow-2xl transition-transform duration-700 group-hover:scale-110" />
